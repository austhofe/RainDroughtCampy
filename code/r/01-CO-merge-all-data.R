...
co_county_info <- read_excel("data/01_co_county-info.xlsx")
...
raw_prism_files <- data_frame(filename = list.files('data/PRISMData/CODailyObserved/'))

raw_prism_file_paths <- raw_prism_files  %>%
  mutate(filepath = paste0("data/PRISMData/CODailyObserved/", filename))
