...
clean_campy_data_week <- healthdf_campy_week %>% 
  left_join(co_county_info, by=c("County" = "county"))
...
clean_prism_data_week <- clean_prism_data_week %>%
  left_join(co_county_info, by=c("FIPS"))
...
final_co_df_analysis_week <- filter(final_co_df_week, year>=2009)

final_co_df_analysis_week$enso <- ifelse(final_co_df_analysis_week$year==2006 | final_co_df_analysis_week$year==2007 | final_co_df_analysis_week$year==2009 | final_co_df_analysis_week$year==2010 | final_co_df_analysis_week$year==2014 | final_co_df_analysis_week$year==2015 | final_co_df_analysis_week$year==2016 | final_co_df_analysis_week$year==2018 | final_co_df_analysis_week$year==2019,1,0)

#### EXPORTING DATA FRAME ####
write.csv(final_co_df_analysis_week, "data\\final_co_df_analysis_week.csv", row.names = T)
